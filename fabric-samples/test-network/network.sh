...
# call the script to create the channel, join the peers of jio and airtel,
...
function networkDown() {
  ...
  # stop org3 containers also in addition to jio and airtel, in case we were running sample to add org3
